...
public class testdis2 extends Activity implements
        DistrictSearch.OnDistrictSearchListener {
    private ListView listView;
    ArrayList<String> test=new ArrayList<String>();
    private  String TAG="testdis2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        query.setKeywords(quhao);//传入关键字
        Intent intent=getIntent();
        quhao=intent.getStringExtra("quhaos");
        Log.d(TAG, "onCreate: "+quhao);
//        Intent intent=new Intent();
//
//        query.setKeywords(intent.getStringExtra("quhao"));//传入关键字
        query.setKeywords(quhao);
...
//获取查询行政区的结果，详细信息可以参考DistrictItem类。
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                Intent intent=new Intent();
                intent.putExtra("jiedao",test.get(arg2));
                setResult(1,intent);
                finish();
            }
